...
export function SkillsBubble() {
  ...
  useEffect(() => {
    ...
    function draw(): boolean {
      ...
      const root = d3.hierarchy<{ label?: string; group?: number; value?: number; children?: typeof BUBBLES }>(
        { children: BUBBLES }
      ).sum((d) => d.value ?? 0);
      d3.pack<{ label?: string; group?: number; value?: number; children?: typeof BUBBLES }>()
